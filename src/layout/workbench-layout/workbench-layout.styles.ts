...
export const workbenchLayoutStyles = css`
  :host { display: block; min-width: 0; }
  .shell { display: grid; gap: var(--pw-space-4); grid-template-columns: minmax(17rem, 0.8fr) minmax(25rem, 1.6fr) minmax(18rem, 0.9fr); align-items: start; }
  .column { min-width: 0; display: grid; gap: var(--pw-space-4); }
